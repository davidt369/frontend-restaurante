    ...
    <DashboardLayout>
      <div className="space-y-6 pb-12">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="w-[280px] justify-start text-left font-normal border-indigo-100 hover:border-indigo-300 transition-colors">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <Card className="lg:col-span-2 shadow-sm border-indigo-50/50">
          ...
          <Card className="shadow-sm border-indigo-50/50">
            <CardHeader>
          ...
          <Card className="lg:col-span-1 shadow-sm border-indigo-50/50">
            <CardHeader>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          {/* Historial de Ventas */}
          <Card className="md:col-span-2 shadow-sm overflow-hidden border-indigo-100">
            <CardHeader >
              <div className="flex items-center justify-between">
                <div>
